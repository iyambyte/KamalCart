package com.kamalbyte.KamalCart.entity;
...
public class Product {
	...
	public Product(Long id, String name, Double price, String description, String category, Double ratings,
			String seller, Integer stock, List<String> images) {
		super();
		this.id = id;
		this.name = name;
		this.price = price;
